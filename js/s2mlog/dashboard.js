document.addEventListener("DOMContentLoaded", function () {
        ...
        ${
          item.type === "file"
            ? `<div class="file-actions">
              ...
              <button class="btn btn-success copy-url-link" onclick="viewFile('${item.encoded_download_url}')">View</button>
  ...
  window.viewFile = function (url) {
    ...
    window.open(`view/#${pdfUrl}`, "_blank");

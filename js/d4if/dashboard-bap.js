document.addEventListener("DOMContentLoaded", function () {
    ...
    const repository = "buktiajar-d4if";
    const foldersToHide = [
      ".vscode",
      "assets",
      "vendors",
    ...
    window.fetchData = function (path = "") {
      ...
      fetch(url, {
        ...
        .then((response) => {
          ...
          document.getElementById("totalFolderCount-bap").textContent = folderCount;
    ...
    function displayDirectoryContents(data, showBackButton) {
      const listContainer = document.getElementById("directory-list2");
      if (!listContainer) {
